      ...
      <div className="w-[90%] md:mt-0  absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-black grid grid-cols-1 md:grid-cols-2 gap-4 flex items-center justify-around">
       <div>
        ...
        <div className="flex flex-col md:w-[70%] w-[90%] ml-5 gap-1">
            ...
            <input required type='text' onChange={(e)=>setContract((pre)=>({...pre,name:e.target.value}))} className="py-3 focus:outline-none pl-2 rounded-lg" />
          </div>
          <div className="flex flex-col md:w-[70%] w-[90%] ml-5 gap-1">
            <label className="text-gray-600">Email</label>
            <input required type='email' onChange={(e)=>setContract((pre)=>({...pre,email:e.target.value}))} className="py-3 focus:outline-none pl-2 rounded-lg" />
          </div>
          <div className="flex flex-col md:w-[70%] w-[90%] ml-5 gap-1">
